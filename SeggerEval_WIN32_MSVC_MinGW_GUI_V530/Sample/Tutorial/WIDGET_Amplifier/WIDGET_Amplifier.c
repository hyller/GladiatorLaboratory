...
static ANIM _aAnim[] = {
  ...
  // Volume up
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,   1000, 90,   190 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel,  10000, 40,   190,    180,    540,  50 },
  // Gain up
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  75,    55 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel,  3000,  55,    55,      0,    270,  20 },
  // High up                                            
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  50,    75 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel,  2000,  50,    55,     90,    270,  20 },
  // Middle up                                          
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  45,    75 },
  {  MOTION_ROUND,   PRESSED,      _Accel,   800,  45,    55,     90,    270,  20 },
  // Wait                                               
  {  MOTION_ROUND, UNPRESSED, _AccelDecel,   500,  45,    55,    270,    270,  20 },
  // Low up                                             
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  20,    70 },
  { MOTION_LINEAR,   PRESSED, _AccelDecel,  1000,  20,    30 },
  // Standby Off                                        
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  75,   220 },
  ...
  // Low down                                           
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  20,    30 },
  { MOTION_LINEAR,   PRESSED, _AccelDecel,  1000,  20,    70 },
  // Middle down                                        
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  45,    35 },
  {  MOTION_ROUND,   PRESSED,      _Accel,   800,  45,    55,    270,     90,  20 },
  // Wait                                               
  {  MOTION_ROUND, UNPRESSED, _AccelDecel,   500,  45,    55,     90,     90,  20 },
  // High down                                          
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  50,    35 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel,  2000,  50,    55,    270,     90,  20 },
  // Gain down                                          
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  55,    35 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel,  2000,  55,    55,    270,      0,  20 },
  // Volume down                                        
  { MOTION_LINEAR, UNPRESSED, _AccelDecel,  1000,  90,   190 },
  {  MOTION_ROUND,   PRESSED, _AccelDecel, 10000,  40,   190,    540,    180,  50 },
  // Standby Off                                        
