...
bool unabto_abuffer_copy(unabto_abuffer* destBuffer, const unabto_abuffer *srcBuffer)
{
    ...
    memcpy(UNABTO_ABUFFER_GET_HEAD(destBuffer), (const void*) UNABTO_ABUFFER_GET_HEAD(srcBuffer), UNABTO_ABUFFER_GET_USED(srcBuffer));
    UNABTO_ABUFFER_SET_USED(destBuffer, UNABTO_ABUFFER_GET_USED(srcBuffer));
    return true;
}
