/*------------------------------------------------------------------*-
   ...
   *** 11.059 MHz oscillator -> 50 ms (precise) tick interval ***
...
void SCH_Init_T2(void) 
   ...
   // -> timer resolution is 0.000001085069444444 seconds (1.085 µs)
   ...
   TH2    = 0x4C;  // load timer 2 high byte
   RCAP2H = 0x4C;  // load timer 2 reload capture reg, high byte
