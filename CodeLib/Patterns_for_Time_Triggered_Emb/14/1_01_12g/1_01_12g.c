/*------------------------------------------------------------------*-
   ...
   *** Uses T1 for timing, 16-bit, manual reload ***
...
static void SCH_Manual_Timer1_Reload(void);
...
-*------------------------------------------------------------------*/
void SCH_Update(void) interrupt INTERRUPT_Timer_1_Overflow 
   {
   tByte Index;
...
-*------------------------------------------------------------------*/
void SCH_Manual_Timer1_Reload()
   {
   // Stop Timer 1
   TR1 = 0;

   // 8051, 12 MHz
   // The Timer 1 resolution is 1.000 µs
